...
{ 
    ...
    $msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,location,token,status) values('$fname','$lname','$email','$password','$contact','$location', 
    $token'.'inactive')");
...
<body>
	...
	<div class="container">
        ...
        <form method="post" name="register" onsubmit="return checkpass();">
